 ...
 */
public class HsTxt extends HsFile implements HsReadable {
    
    public HsTxt(){
    }
    
    public HsTxt(String path){
        super.setPath(path);
    }
    
    public HsTxt (String path, String name, String ext){
       super(path, name, ext);
    }
    ...
    public HsReadable newOne(String path, String name, String ext) {
        return new HsTxt(path, name, ext);
    }
}